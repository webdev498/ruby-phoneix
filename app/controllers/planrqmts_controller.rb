class PlanrqmtsController < ApplicationController
  before_action :set_planrqmt, only: [:show, :edit, :update, :destroy]

  # GET /planrqmts
  # GET /planrqmts.json
  def index
    @planrqmts = Planrqmt.all
  end

  # GET /planrqmts/1
  # GET /planrqmts/1.json
  def show
  end

  # GET /planrqmts/new
  def new
    @planrqmt = Planrqmt.new
  end

  # GET /planrqmts/1/edit
  def edit
  end
  ...
  # POST /planrqmts.json
  def create
    @planrqmt = Planrqmt.new(planrqmt_params)

    respond_to do |format|
      if @planrqmt.save
        format.html { redirect_to @planrqmt, notice: 'Planrqmt was successfully created.' }
        format.json { render :show, status: :created, location: @planrqmt }
      else
        format.html { render :new }
        format.json { render json: @planrqmt.errors, status: :unprocessable_entity }
      end
    end
  end

  # PATCH/PUT /planrqmts/1
  # PATCH/PUT /planrqmts/1.json
  def update
    respond_to do |format|
      if @planrqmt.update(planrqmt_params)
        format.html { redirect_to @planrqmt, notice: 'Planrqmt was successfully updated.' }
        format.json { render :show, status: :ok, location: @planrqmt }
      else
  ...
  # DELETE /planrqmts/1
  # DELETE /planrqmts/1.json
  def destroy
    @planrqmt.destroy
    respond_to do |format|
      format.html { redirect_to planrqmts_url, notice: 'Planrqmt was successfully destroyed.' }
