...
RSpec.describe "cdb_drug_references/new", type: :view do
  before(:each) do
    assign(:cdb_drug_reference, CdbDrugReference.new(
      :ndc_number => 1,
      :ndc_number10 => 1,
      :ddid_number => 1,
      :kdc_code => 1,
  ...
  it "renders new cdb_drug_reference form" do
    render

    assert_select "form[action=?][method=?]", cdb_drug_references_path, "post" do
